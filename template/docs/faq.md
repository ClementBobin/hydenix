...
inputs = {
    ...
    hydenix = {
      # Available inputs:
      # Main: github:ClementBobin/hydenix
      # Dev: github:ClementBobin/hydenix/dev
      # Commit: github:ClementBobin/hydenix/<commit-hash>
      # Version: github:ClementBobin/hydenix/v1.0.0
...
- **always review [release notes](https://github.com/ClementBobin/hydenix/releases) for major updates (api changes)**
...
or create an issue in the [hydenix GitHub repository](https://github.com/ClementBobin/hydenix/issues).
...
please open a [feature request](https://github.com/ClementBobin/hydenix/issues/new?template=feature_request.md) if you have any feature requests.
