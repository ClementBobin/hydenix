...
[search for `hydenix.hm.theme`](https://github.com/ClementBobin/hydenix/search?q=hydenix.hm.theme)
  ...
  hydenix = {
    ...
    hm = {
      ...
      editors = {
        ...
        vscode.enable = true; # enable vscode module
        vscodium.enable = true; # enable vscodium module
      ...
      theme = {
        ...
        themes = [ "Catppuccin Mocha" "Catppuccin Latte" ]; # default enabled themes, full list in https://github.com/ClementBobin/hydenix/tree/main/hydenix/sources/themes
      };
      waybar = {
